        ...
        <>
           <div className='scroll'>
                <div style={{ position: "relative" }}>
                    ...
                    <img className='image' width={'100%'} height={'750px'} src={med1} alt="" />
                </div>
                <div>
                    <div className='container-fulid'>
                        <Row style={{ padding: "80px" }} >
                            ...
                            <Col sm={1} md={8}>
                                <div  >
                                    <div className='d-flex head2' style={{ justifyContent: "space-evenly" }}>
                                    ...
                                    <hr />
                                    <br />
                                    <div className='d-flex head3' style={{ justifyContent: "space-around" }}>
                ...
                <Row>
                    ...
                    <Col md={12} sm={6}>
                        ...
                        <div className='background' style={{ textAlign: "center", marginTop: "80px" }}>
                            ...
                            <Link to={'/docdetails'}><Button style={{ backgroundColor: "white", color: "black", fontSize: "30px" }} className='btn btn-outline rounded'>Find Doctor</Button></Link>
                        </div>
                    </Col>
                </Row>
                <div style={{ position: "relative", marginTop: "-120px" }}>
                    <div style={{ position: "absolute" }}>
                        ...
                        <Link className='button' to={'/bloodlogin'}> <button style={{ color: "red", fontSize: "30px", marginTop: "80px", borderRadius: "10px", fontWeight: "bolder", backgroundColor: "white" }}>Become a Donor <i class="fa-solid fa-arrow-right fa-beat"></i></button></Link>
